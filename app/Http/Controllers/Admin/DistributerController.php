...
class DistributerController extends Controller{
    ...
    public function getList(Request $request){
        ...
        return view('/panel/distributers/index');
    }
    ...
    public function listPaginate(Request $request){
        ...
        $query = self::$AdminUser->where('status', '!=', 3)->where('type', 'Distributer');
        ...
        return view('/panel/distributers/paginate', compact('records'));
    ...
    public function addPage(Request $request){
        ...
        return view('/panel/distributers/add-page');
