...
class ManyfacturerController extends Controller{
    ...
    public function getList(Request $request){
        ...
        return view('/panel/manufacturers/index');
    }
    ...
    public function listPaginate(Request $request){
        ...
        $query = self::$AdminUser->where('status', '!=', 3)->where('type', 'Manufacturer');
        ...
        return view('/panel/manufacturers/paginate', compact('records'));
    ...
    public function addPage(Request $request){
        ...
        return view('/panel/manufacturers/add-page');
