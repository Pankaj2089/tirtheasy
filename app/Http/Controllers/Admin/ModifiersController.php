...
class ModifiersController extends Controller{
    ...
    public function getList(Request $request){
        ...
        return view('/panel/modifiers/index');
    }
    ...
    public function listPaginate(Request $request){
        ...
        $query = self::$AdminUser->where('status', '!=', 3)->where('type', 'Modifier');
       if($request->input('search_title') && $request->input('search_title') != ""){
        ...
        return view('/panel/modifiers/paginate', compact('records'));
    ...
    public function addPage(Request $request){
        ...
        return view('/panel/modifiers/add-page');
