...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="card mb-2 p-3">
    <form id="searchForm" name="searchForm">
      <div class="row">
        <div class="col-md-4">
          <input type="text" class="form-control" name="search_title" placeholder="Enter User Name, Property ID, Mobile, Email" id="search_title" />
        </div>
        <div class="col-md-2">
  ...
  <div class="card">
    <h5 class="card-header">Vendors <a onclick="$('#popupHeading').html('Add Customer');clearForm();" style="float:right; color:#FFF" data-bs-toggle="modal" data-bs-target="#addNewCCModal" class="btn btn-success waves-effect waves-light">Add</a></h5>
      ...
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div class="text-center mb-6">
            <h4 id="popupHeading" class="mb-2">Add Vendor</h4>
          ...
          <input type="hidden" id="row_id" name="row_id" value="0" />
            <div class="col-12 form-control-validation">
              <label class="form-label w-100" for="login_id">Login User Name</label>
              <div class="input-group-merge">
                <input id="login_id" name="login_id" class="form-control credit-card-mask" placeholder="Please enter login user name" type="text" />
              </div>
            </div>
            ...
            <div class="col-12 form-control-validation password">
	...
	$.ajax({
		...
		success: function(response){
			...
			if(obj['heading'] == "Success"){
				...
				$('#login_id').val(obj['record']['login_id']);
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "{{ url('/panel/vendors_paginate') }}",
		success: function(response){
