...
role="tab" aria-selected="true"> <span class="icon-base ti tabler-user icon-lg d-sm-none"></span><span class="d-none d-sm-block">General Info</span> </button>
        ...
        <button type="reset" onclick="window.location.href='{{route('admin.banners')}}'" class="btn btn-label-secondary" >Cancel</button>
        </div>
        </div>
        </div>
        </div>
...
<script>
    let saveDataURL = "{{url('/panel/add-banner')}}";
