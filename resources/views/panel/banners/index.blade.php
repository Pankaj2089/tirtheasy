...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <a style="color:#FFF" onclick="resetFilterForm();" class="btn btn-danger waves-effect waves-light">Reset</a>
    ...
    <div class="card">
      <h5 class="card-header">Banner Management <a href="{{url('/panel/add-banner')}}" style="float:right; color:#FFF"class="btn btn-success waves-effect waves-light">Add</a></h5>
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "{{ url('/panel/banners_paginate') }}",
