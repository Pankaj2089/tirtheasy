...
role="tab" aria-selected="false"> <span class="icon-base ti tabler-user-cog icon-lg d-sm-none"></span><span class="d-none d-sm-block">SEO Details</span> </button>
               ...
               <div class="row g-6">
                  ...
                  <div class="col-md-4">
                    ...
                    <select type="text" id="category" name="category" class="form-select" >
                        <option value="Most Popular" {{$record->category == "Most Popular" ? 'selected':''}} >Most Popular</option>
                        <option value="Best Accommodation" {{$record->category == "Best Accommodation" ? 'selected':''}} >Best Accommodation</option>
                        <option value="Events" {{$record->category == "Events" ? 'selected':''}} >Events</option>
                        <option value="Darshan Stories" {{$record->category == "Darshan Stories" ? 'selected':''}} >Darshan Stories</option>
                    </select>
                  </div>

                  <div class="col-md-12">
                    <label class="form-label" for="short_description">Short Description</label>
                    <input type="text" id="short_description" name="short_description" class="form-control" value="{{$record->short_description}}" />
                  </div>
                  <div class="col-md-12">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="date" id="blog_date" name="blog_date" class="form-control" value="{{$record->blog_date}}" />
                  </div> 
                  <div class="col-md-4">
            ...
            <div class="tab-pane fade" id="form-tabs-account" role="tabpanel">
                <div class="row g-6">
                  ...
                  <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" id="seo_keyword" name="seo_keyword" value="{{$record->seo_keyword}}" />
                  </div>
                  <div class="col-md-12">
        ...
        <div class="col-12 col-md-3">
            <div class="card mb-6">
                ...
                @if($record->image != '')
                  <div class="col-md-12">
                    <img src="{{$siteUrl}}/public/img/blogs/{{$record->image}}" width="100%" />
                  </div>
                  @endif
                </div>
                    <div class="pt-6">
...
var addUrl = "{{url('/panel/edit-blog/')}}/{{$record->id}}";
        ...
        success: function(response){
          ...
          if(obj['heading'] == "Success"){
            swal("", obj['msg'], "success").then((value) => {
              window.location.href = "{{url('/panel/edit-blog/')}}/{{$record->id}}";
            });
