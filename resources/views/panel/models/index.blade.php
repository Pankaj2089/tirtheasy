...
@section('content')
            ...
            <div class="col-md-2">
            <select name="search_brand_id" class="form-select">
            ...
            <a style="color:#FFF" onclick="resetFilterForm();" class="btn btn-danger waves-effect waves-light">Reset</a>
              ...
              <div class="card">
                <h5 class="card-header">Models <a onclick="$('#popupHeading').html('Add New Model');clearForm();" style="float:right; color:#FFF" data-bs-toggle="modal"
                  ...
                  <div class="modal-content">
                    <div class="modal-body">
                      ...
                      <div class="col-12 form-control-validation">
                          <label class="form-label w-100" for="title">Brand</label>
                        ...
                        <div class="col-12 form-control-validation">
                          <label class="form-label w-100" for="title">SEO Title</label>
                          <div class="input-group-merge">
                            <input id="seo_title" name="seo_title" class="form-control" placeholder="Please enter title" type="text"  />
                          </div>
                        </div>
                        <div class="col-12 form-control-validation">
                          <label class="form-label w-100" for="title">SEO Description</label>
                          <div class="input-group-merge">
                            <textarea id="seo_description" name="seo_description" class="form-control" ></textarea>
                          </div>
                        </div>
                        <div class="col-12 form-control-validation">
                          <label class="form-label w-100" for="title">SEO Keywords</label>
                          <div class="input-group-merge">
...
var addUrl = "{{route('admin.add-model')}}";
var getUrl = "{{route('admin.get-model')}}";
	...
	$.ajax({
		...
		success: function(response){
			...
			if(obj['heading'] == "Success"){
				...
				$('#brand_id').val(obj['record']['brand_id']);
