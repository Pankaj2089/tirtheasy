...
@section('content')
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <a style="color:#FFF" onclick="resetFilterForm();" class="btn btn-danger waves-effect waves-light">Reset</a>
              ...
              <div class="card">
                <h5 class="card-header">Categories <a onclick="$('#popupHeading').html('Add New Category');clearForm();" style="float:right; color:#FFF" data-bs-toggle="modal"
                  ...
                  <div class="modal-content">
                    <div class="modal-body">
                      ...
                      <input type="hidden" id="row_id" name="row_id" value="0" />
                        ...
                        <div class="col-12 form-control-validation d-none">
...
var addUrl = "{{route('admin.add-room-category')}}";
var getUrl = "{{route('admin.get-room-category')}}";
...
function getDetails(rowId){
	$('#popupHeading').html('Edit Category');
	$.ajax({
        headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
        type: 'POST',
		data:{rowId:rowId},
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "{{ url('/panel/room_categories_paginate') }}",
		success: function(response){
