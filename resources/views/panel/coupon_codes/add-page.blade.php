...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="row">
    <div class="col">
      <h6 class="mt-6">Add New Coupon Code</h6>
      <div class="row">
                ...
                <div class="row g-6">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control numberonly" maxlength="6" name="amount" id="amount">
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="form-group">
...
<script>
    let saveDataURL = "{{url('/panel/add-coupon-code')}}";
