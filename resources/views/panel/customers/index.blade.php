...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    <h5 class="card-header">Customers <a onclick="$('#popupHeading').html('Add Customer');clearForm();" style="float:right; color:#FFF" data-bs-toggle="modal" data-bs-target="#addNewCCModal" class="btn btn-success waves-effect waves-light">Add</a></h5>
      ...
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div class="text-center mb-6">
            <h4 id="popupHeading" class="mb-2">Add User</h4>
          ...
          <input type="hidden" id="row_id" name="row_id" value="0" />
            ...
            <div class="col-12 form-control-validation">
              ...
              <div class="input-group-merge">
                <input id="email" name="email" class="form-control credit-card-mask" placeholder="Please enter email" type="text" readonly />
              </div>
            </div>
            <div class="col-12 form-control-validation">
...
var addUrl = "{{route('admin.add-user')}}";
var getUrl = "{{route('admin.get-user')}}";
