...
@section('content')
            ...
            <div class="row">
            <div class="col-md-2">
            <input type="text" class="form-control" name="search_title" placeholder="Enter Page Title" maxlength="4" id="defaultFormControlInput" />
            </div>
            ...
            <a style="color:#FFF" onclick="resetFilterForm();" class="btn btn-danger waves-effect waves-light">Reset</a>
              ...
              <div class="card">
                <h5 class="card-header">Inner Pages</h5>
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "{{ url('/panel/inner-pages_paginate') }}",
