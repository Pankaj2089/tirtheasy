@if($records->count()>0)
    ...
    <tr>
        ...
        <!-- <td>
            ...
            @endphp
            <a style="cursor:pointer" onclick="changeStatus('inner_pages','{!!$row->id!!}');" id="status_{{$row->id}}" class="badge {{$class}} me-1">{{$label}}</a>
        ...
        <td>
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" style="cursor:pointer" href="{{url('/panel/edit-inner-page/')}}/{{$row->id}}"><i class="icon-base ti tabler-pencil me-1"></i> Edit</a>
                </div>
            </div>
        </td>
    </tr>
