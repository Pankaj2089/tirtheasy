...
@section('content')
  ...
  <a style="color:#FFF" onclick="resetFilterForm();" class="btn btn-danger waves-effect waves-light">Reset</a>
    ...
    <div class="card">
      <h5 class="card-header">States <a onclick="$('#popupHeading').html('Add New State');clearForm();" style="float:right; color:#FFF" data-bs-toggle="modal"
...
var addUrl = "{{route('admin.add-state')}}";
var getUrl = "{{route('admin.get-state')}}";
