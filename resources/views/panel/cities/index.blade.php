...
@section('content')
  ...
  <div class="row">
    ...
    <div class="col-md-2">
      <select name="search_state_id" class="form-select select2">
    ...
    <div class="card">
      <h5 class="card-header">Cities <a onclick="$('#popupHeading').html('Add New State');clearForm();" style="float:right; color:#FFF" data-bs-toggle="modal"
        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="text-center mb-6">
              <h4 id="popupHeading" class="mb-2">Add New State</h4>
            ...
            <div class="col-12 form-control-validation">
                <label class="form-label w-100" for="title">State</label>
...
var addUrl = "{{route('admin.add-city')}}";
var getUrl = "{{route('admin.get-city')}}";
	...
	$.ajax({
		...
		success: function(response){
			...
			if(obj['heading'] == "Success"){
				...
				$('#state_id').val(obj['record']['state_id']);
			}else{
				swal("Error!", obj['msg'], "error");
				return false;
			}
