...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="row">
    <div class="col">
      <h6 class="mt-6">Add Popular Destination</h6>
      <div class="row">
            ...
            <div class="tab-pane fade active show" id="form-tabs-personal" role="tabpanel">
                <div class="row g-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Title" value="" name="heading" id="heading">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
...
<script>
    let saveDataURL = "{{url('/panel/add-popular-destination')}}";
				...
				var obj = JSON.parse(response);
				 if(obj['heading'] == "Success"){
					...
					swal("", obj['msg'], "success").then((value) => {
						window.location.href = "{{route('admin.popular-destinations')}}";
					});
				}else{
